	...
	<body class="page">
		...
		<div id="main">
        	...
        	<div class="cf">        	
	        	...
	        	<h3 class="heading">회원 관리</h3><br>
					<table class="type09" id="memberTable">
					...
					<c:when test="${empty list}">
						...
						<tr style="height: 64px;">
							...
							<td style="text-align:center">${admin.email}</td>
						 	<td style="text-align:center">${admin.authority}	</td>   
						 	<td style="text-align:center">${admin.idate}</td>
					 	 	<td style="text-align:center"><a href='adminMemberUpdate?id=${admin.id}' >수정</td> 
						</tr>
						</c:forEach>
					</c:otherwise>  
					</c:choose>
