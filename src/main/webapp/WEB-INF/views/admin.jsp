	        	...
	        	<form name="form1" method="get">
					...
					<c:when test="${empty list}">
						...
						<tr style="height: 64px;">
							<td style="text-align:center">${goods.rnum}</td>	
							<td style="text-align:center">${goods.id}</td>
							<td style="text-align:center"><img width="100px" height="75px" src="${pageContext.request.contextPath}/${goods.image}"/></td>
							<td style="text-align:center"><a href='detail?rnum=${goods.rnum}'>${goods.goodsName}</a></td>
							<!-- id로 상세페이지를 구분해 줘야함. -->
					 		<td style="text-align:center">${goods.deliveryCharge}</td> 
							<td style="text-align:center">${goods.goalNum}</td>
						 	<td style="text-align:center">${goods.sellStart}</td> 
						 	<td style="text-align:center">${goods.sellEnd}</td>
						 	<td style="text-align:center"><a href='delete?rnum=${goods.rnum}'>삭제</a></td>
						</tr>
						</c:forEach>
					</c:otherwise>
					</c:choose>
